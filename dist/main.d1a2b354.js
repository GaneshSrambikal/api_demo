...
function fetchAnimals(e) {
  ...
  if (!(0, _validate.isValidZip)(zip)) {
    (0, _validate.showAlert)("Enter a valid zip", "danger");
    return;
  }

  //fetch pets
  (0, _fetchJsonp2.default)("http://api.petfinder.com/pet.find?format=json&key=7c62cb95c0acffdf76f9e0c1c368b4b5&animal=" + animal + "&location=" + zip + "&callback=callback", { jsonpCallbackFunction: "callback" }).then(function (res) {
    return res.json();
  }).then(function (data) {
...
},{"fetch-jsonp":"node_modules\\fetch-jsonp\\build\\fetch-jsonp.js","./validate":"js\\validate.js"}],"C:\\Users\\Gnshsrmbkl\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.d1a2b354.map